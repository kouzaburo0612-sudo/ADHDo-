...
const SLIDES = [
  ...
  },
  {
    emoji: '🩺',
    title: 'Body Data',
    body: 'Oura・Withings・Apple Watchの全データを体組成・心血管・睡眠・活動・リカバリーの5系統で一覧。カードをタップすると期間別のグラフが見られます。',
  },
  {
    emoji: '💬',
    title: 'Mr. Vyta',
    body: '「昼はいつもの」「昨日の夜ステーキ食べた」と話すか、📷で食事の写真を送るだけで記録完了。運動・ストレス・設定変更もぜんぶチャットでできます。',
  },
];
